...
public class DBConfig {
    ...
    public static boolean rdb_compression = false;

    private int numDatabases = DEFAULT_DATABASES;

    private boolean persistenceActive = true;
    ...
    public boolean isRdb_compression() {
        return rdb_compression;
    }

    public void setRdb_compression(boolean rdb_compression) {
        DBConfig.rdb_compression = rdb_compression;
    }
    ...
    public static class Builder {
        ...
        public Builder withRdbCcompression() {
            config.setRdb_compression(true);
            return this;
        }
