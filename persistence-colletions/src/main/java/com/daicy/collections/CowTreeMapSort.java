...
// */
//public final class CowTreeMapSort<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, CowOrderedMap<K, V> {
...
//         * </pre>
//         */
//        Node<K, V> mergeChildAt(CowTreeMapSort<K, V> editor, int index) {
...
//         * </pre>
//         */
//        private Node<K, V> mergeChildrenAt(CowTreeMapSort<K, V> editor, int keyIndex, int childIndex, Node<K, V> left, Node<K, V> right) {
...
//        }
//
//        Node<K, V> replaceWithChildValueAt(CowTreeMapSort<K, V> editor, int replaceIndex) {
...
//        }
//
//        private Node<K, V> replaceWithSuccessor(CowTreeMapSort<K, V> editor, int replaceIndex, Node<K, V> right) {
...
//         * </pre>
//         */
//        private Node<K, V> replaceWithPredecessor(CowTreeMapSort<K, V> editor, int replaceIndex, Node<K, V> left) {
//            Node<K, V> me = this.editable(editor.generation);
//            Node<K, V> parent = me;
...
//     */
//    public CowTreeMapSort(Comparator<K> comparator) {
//        //noinspection unchecked
//        this(EMPTY_NODE.generation + 1, 0, (Node<K, V>) EMPTY_NODE, comparator);
//    }
//
//    private CowTreeMapSort(long generation, int size, Node<K, V> root, Comparator<K> comparator) {
//        this.size = size;
//        this.root = root;
...
//            value = CowTreeMapSort.this.put(key, value);
//            return value;
//        }
//
//        @Override
...
//        @Override
//        public void remove() {
//            CowTreeMapSort.this.remove(lastReturned.getKey(), lastReturned.getValue());
//        }
//    }
//
...
//
//    @Override
//    public CowTreeMapSort<K, V> fork() {
//        return new CowTreeMapSort<>(++generation, size, root, comparator);
//    }
//
//    //endregion
//
...
//
//    /**
//     * Returns the first Entry in the CowTreeMapSort (according to the CowTreeMapSort's
//     * key-sort function).  Returns null if the CowTreeMapSort is empty.
//     */
//    final Entry<K, V> getFirstEntry() {
//        NodeStack<K, V> stack = new NodeStack(null, root, 0).firstChild();
//        return new SettableEntry(stack.getKey(), stack.getValue());
//    }
//
//    /**
...
//
//    /**
//     * Returns the last Entry in the CowTreeMapSort (according to the CowTreeMapSort's
//     * key-sort function).  Returns null if the CowTreeMapSort is empty.
//     */
//    final Entry<K, V> getLastEntry() {
//        NodeStack<K, V> stack = new NodeStack<>(null, root, root.numKeys - 1).lastChild();
//        return new SettableEntry(stack.getKey(), stack.getValue());
//    }
//
//
...
//
//    @Override
//    public NavigableMap<K, V> subMap(Object fromKey, boolean fromInclusive, Object toKey, boolean toInclusive) {
