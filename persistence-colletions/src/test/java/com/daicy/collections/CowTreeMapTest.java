...
import com.daicy.collections.CowTreeMap;
...
public class CowTreeMapTest {
    ...
    public void iterate() {
        ...
        Iterable<Map.Entry<String, Object>> entryIterable = b.descendingEntriesBefore("99", true);
        for (Map.Entry<?,?> o : entryIterable) {
    ...
    @Test
    public void iterateAscendingEntriesAfter() {
        String[] elements = zigZag(99);
        ...
        Map<Object, Object> check = new TreeMap<>();
        for (Map.Entry<?,?> o : b.ascendingEntriesAfter("00",true)) {
            check.put(o.getKey(), o.getValue());
        }
    ...
    @Test
    public void iterateAscendingSubEntries() {
//        CowTreeMapCopy<String, Object> b = new CowTreeMapCopy<>(Comparator.<String>naturalOrder());
        ...
        Map<Object, Object> check = new TreeMap<>();
        for (Map.Entry<?,?> o : b.ascendingSubEntries("10",false,"20",true)) {
            check.put(o.getKey(), o.getValue());
        }
