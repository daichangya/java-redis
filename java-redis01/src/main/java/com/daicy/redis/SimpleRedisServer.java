...
import static com.daicy.redis.common.Encoding.bytesToNum;
import static com.daicy.redis.common.Encoding.numToBytes;
import static com.daicy.redis.protocal.reply.BulkReply.NIL_REPLY;
import static com.daicy.redis.protocal.reply.IntegerReply.integer;
import static com.daicy.redis.protocal.reply.StatusReply.OK;
import static com.daicy.redis.protocal.reply.StatusReply.QUIT;
...
public class SimpleRedisServer implements RedisServer {
  ...
  public MultiBulkReply zrange(byte[] key0, byte[] start1, byte[] stop2, byte[] withscores3) throws RedisException {
    ...
    List<Reply<byte[]>> list = new ArrayList<Reply<byte[]>>();
